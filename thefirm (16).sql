...
--
-- Host: 127.0.0.1
-- Generation Time: May 11, 2025 at 04:25 PM
...
INSERT INTO `address` (`id`, `x`, `y`, `details`, `city`, `building`, `street`) VALUES
(1, 38, -122, 'in front of the Quebec Hotels', 'San Francisco', 'Francy', 'F.12 Street'),
(15, 38, -123, 'in front of Bank Audi:', 'Quebec:', 'Main Tower:', 'Reine\'s Street'),
(16, 38, -122, 'in front of Bank Audi:', 'Quebec:', 'Main Tower:', 'Reine\'s Street'),
(17, 39, -117, 'in front of Byblos Bank', 'Hamra', 'Tower#4', 'YXYXY\'s Street'),
(19, 38, -192, 'in front of Usj', 'Ashrafiyeh', 'NNN\'s', 'Nad\'s Street'),
(21, 38, -122, 'near City Hall', 'Ottawa', 'Capital Center', 'Queen'),
(23, 38, -122, 'in front FB Bank', 'Beirut', 'Four season', 'Reine\'s');
...
INSERT INTO `case` (`id`, `description`, `startdate`, `enddate`, `status`, `casestatus`, `userid`, `categoryid`, `attid`) VALUES
(24, 'killed someone', '2025-03-07', '0000-00-00', 'Pending', 'Pending', 11, 1, 8),
(26, 'A businessman was attacked in his home, revealing a crime driven by betrayal and revenge.', '2025-03-10', '0000-00-00', 'Pending', 'Pending', 12, 1, 8),
(37, 'Last week,when i came home at 5:08 pm someone was following me from the resto when i was to the home . then when i got out of my car,this guy has hurt me and killed me.', '2025-03-18', '2025-04-24', 'Accepted', 'Pending', 10, 1, 8),
(38, 'From a year ago,when i went to the beach at 3:02 am someone was following me from my home to the batroun beach. then when i got out of my goods,this guy has hurt me and killed me.', '2025-03-18', '2025-04-15', 'Accepted', 'Pending', 7, 1, 8),
(39, 'I am facing allegations of campaign finance violations, including improper donations and funding disclosures, and need legal guidance to navigate compliance and potential penalties.', '2025-03-20', '0000-00-00', 'Accepted', 'Pending', 17, 2, 19),
(47, 'I was walking at night and man tried to kill me, so i had to defend myself and i ended up killing him .Suddenly Tante Sabah started Screaming and her daughter Carole ran from the 1st floor to the  backyard to bring the Stick .  ', '2025-05-09', '2025-05-09', 'Accepted', 'Pending', 33, 1, 8),
(48, 'A whistleblower exposed high-level government corruption involving illicit campaign funding. The case led to multiple resignations and new transparency laws.', '2025-05-09', '2025-05-09', 'Accepted', 'Pending', 33, 2, 11);
...
INSERT INTO `ccontract` (`id`, `description`, `total`, `nbrofpay`, `status`, `caseid`) VALUES
(1, 'Client has filed a criminal case and wishes to pay the attorney\'s fee in fourth installments.', 4000, 4, 'Accepted', 38),
(2, 'Client has filed a criminal case and wishes to pay the attorney\'s fee in fourth installments.', 4000, 4, 'Accepted', 37),
(5, 'Client has filed a criminal case and wishes to pay the attorney\'s fee in two installments.', 10000, 2, 'Accepted', 48);
...
INSERT INTO `chatbot` (`id`, `userid`, `questid`) VALUES
(1, 10, 7),
(2, 10, 8);
...
INSERT INTO `meetings` (`id`, `link`, `status`, `date`, `time`, `caseid`) VALUES
(18, 'https://www.example.com/abc123', 'Done', '2025-12-04', '01:45', 37),
(21, 'https://zoom.us', 'Pending', '2025-12-04', '12:30', 39),
(22, 'https://zoom.us', 'Pending', '2025-10-05', '09:15', 39),
(25, 'https://zoom.us', 'Pending', '2025-05-16', '01:20', 38),
(26, 'https://example.com', 'Pending', '2025-09-12', '02:22', 39),
(28, 'https://www.example.com/dfd232', 'Pending', '2025-05-25', '09:15', 48);
...
(2, '2025-07-01', 'UnPaid', 1000, 1),
(3, '2025-08-01', 'UnPaid', 1000, 1),
...
(3, '2025-04-05', '01:02', 'Please bring your case documents.', 37, 15),
(4, '2025-04-05', '01:02', 'Please bring your case documents.', 38, 16),
...
(12, 'Reine', 'Nassour', 'reinenassour004@gmail.com', '$2y$10$0zTCv37AHvhZ96OJYP3TZuGWbeCfv3wfpm1SyCCilned0W/K4pfGG', 'Miniara,Akkar', 8181818, '0', 0, 'Unrestricted'),
...
(18, 'Wajd', 'Awad', 'wwtt19789@gmail.com', '$2y$10$QjXP.HI/Vq07LDsnaDz/Oe5y5/MSGcfC7hlxkoJkS6GIrzpwqTaiK', 'Miniara,Akkar', 676767, '0', 3, 'Unrestricted'),
