                ...
                <div class="container">
                    ...
                    <div class="collapse navbar-collapse" id="navbarMain">
                        <ul class="navbar-nav ml-auto mr-3">
                            <li class="nav-item">
                                <a class="nav-link px-3" href="dashboard.php" style="color: #1a2236; font-weight: 500;">Dashboard</a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a class="nav-link px-3" href="contacts.php" style="color: #1a2236; font-weight: 500;">Contacts</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link px-3" href="passedlawyers.php" style="color: #1a2236; font-weight: 500;">PassedLawyers</a>
                            </li>
