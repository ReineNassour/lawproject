...
include 'header.php';
   ?>
        ...
        <div class="container dashboard-container">
            <h2 class="dashboard-title">Case Management Dashboard</h2>
    ...
    <?php if ($status == "Rejected") { ?>
        <a href="?acceptid=1&nbb=<?= $row['id'] ?>" class="btn btn-success btn-action">
            <i class="fas fa-check mr-1"></i> Accept
        </a>
    <?php } else if ($status == "Accepted") { ?>
        <a href="?acceptid=0&nbb=<?= $row['id'] ?>" class="btn btn-danger btn-action">
