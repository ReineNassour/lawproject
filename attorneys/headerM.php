                       ...
                       <?php if (isset($_SESSION['manager'])) { ?>
                            <div class="user-menu dropdown">
                                <a class="dropdown-toggle d-flex align-items-center" href="#" role="button" id="userDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    ...
                                    <div class="user-info">
                                        <span style="color: #1a2236; font-weight: 500;"><?php echo $_SESSION['manager']['fullName']; ?></span>
                                        <input type="hidden" name="attid" value="<?=  $_SESSION['manager']['id']; ?>">
                                        <small class="d-block text-muted">Attorneys Chief</small>
                                    </div>
                                </a>
